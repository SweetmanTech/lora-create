...
const ZoraCreateProvider = ({ children }: any) => {
  ...
  return (
    <ZoraCreateContext.Provider value={{ create, creating, ...createMetadata }}>
      {children}
...
const useZoraCreate = () => {
  ...
  if (!context) {
    throw new Error('useZoraCreate must be used within a ZoraCreateProvider')
  }
  return context
}

export { ZoraCreateProvider, useZoraCreate }
